  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="http://localhost:8000/products" class="nav-link px-2 text-white">Products</a></li>
      ...
      <?php if(auth()->guard()->check()): ?>
        ...
        <?php echo e(auth()->user()->email); ?>&nbsp;&nbsp;-- <?php echo e(Auth::user()->name); ?>
...
</header><?php /**PATH C:\AppServ\www\login3\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>